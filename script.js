...
const drinks = [
  ...
  // ✅ مشكل فستق حلبي - مع 6 صور
  {
    ...
    desc: "مزيج فاخر من أفضل أنواع البقلاوة بالفستق الحلبي الممتاز( قابل لتعديل الاصناف )",
  ...
  // ✅ مشكل لوز حلبي - مع 6 صور
  {
    ...
    desc: "مزيج فاخر من أفضل أنواع البقلاوة باللوز الممتاز( قابل لتعديل الاصناف )",
    ingredients: ["حبوب قهوة عربية", "ماء", "رغوة حليب"]
  },
