...
window.addEventListener("load", () => {
  ...
  }, 1000); // قللت الوقت شوية عشان السرعة
});
...
function closeModal() {
  ...
  setTimeout(() => { modalOverlay.classList.add("hidden"); }, 320);
}
...
function renderCartItems() {
  ...
  cart.forEach((item, index) => {
    ...
    itemDiv.style = "display:flex; justify-content:space-between; align-items:center; background:rgba(255,255,255,0.05); padding:10px; border-radius:8px; margin-bottom:10px;";
    itemDiv.innerHTML = `
